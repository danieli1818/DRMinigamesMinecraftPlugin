package com.danieli1818.drminigames.common.arenalogics.listeners;
...
public abstract class BaseArenaLogicListener implements ArenaLogicListener {
	...
	public void onPlayerKickEvent(PlayerKickEvent event) {
		getArenaLogic().removePlayer(event.getPlayer());
	}
